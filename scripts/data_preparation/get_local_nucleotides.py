    ...
    for termini in terminis:
        ...
        for index, miRNA_row in consensus_tb.iterrows():
            ...
            if (pri_miRNA in miRBase):
                ...
                if (code == CLEAVAGE_POSITION_ERR):
                    continue

                if (code != UPP_SIDE_ERR and code != BOTH_SIDE_ERR):
                    table_upp_gap.loc[len(table_upp_ungap)] = [
                        pri_miRNA,
                        miRNA,
                        features[0],
                        heterogenous
                ...
                if (code != DWN_SIDE_ERR and code != BOTH_SIDE_ERR):
                    table_dwn_gap.loc[len(table_dwn_ungap)] = [
                        pri_miRNA,
                        miRNA,
                        features[1],
                        heterogenous
